...
data = pd.read_csv("D:\Lap trinh\MayHocUngDung\TH1_KNN\Data\winequality-red.csv", sep=';')
...
# =====================================================
# Chuyen quality ve bai toan PHAN LOAI
# =====================================================
...
# =====================================================
# c. CHIA DU LIEU: 4 PHAN TRAIN - 1 PHAN TEST (80% - 20%)
# =====================================================
...
# =====================================================
# d. KNN PHAN LOAI - k = 9 (KHONG CHUAN HOA)
# =====================================================
...
# In nhan du doan va thuc te 7 phan tu dau
print("7 phan tu dau tap test:")
for i in range(7):
    print(f"Thuc te: {y_test.iloc[i]}, Du doan: {y_pred[i]}")

print("Do chinh xac 7 phan tu dau:",
      accuracy_score(y_test.iloc[:7], y_pred[:7]))
print()
...
# =====================================================
# KNN PHAN LOAI - k = 9 (SAU CHUAN HOA)
# =====================================================
